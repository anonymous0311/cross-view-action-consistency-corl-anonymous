# Phase 0A Original LIBERO Rerender Scripts

Phase 0A now uses the original LIBERO HDF5 archives, not the LIBERO-plus
...
The next Phase 0A script should be
`scripts/v4/phase0A/render_libero_multiview_states.py`: render same-state
