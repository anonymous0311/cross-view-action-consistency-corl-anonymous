"""Smoke-test Phase 0B paired LeRobot dataloader output shapes.

This does not start training. It loads one batch and verifies the v4 pair axis,
...
def main() -> None:
    ...
    if unexpected_wrist_keys:
        raise AssertionError(f"wrist images should be omitted for v4 Phase 0B: {sorted(unexpected_wrist_keys)}")
