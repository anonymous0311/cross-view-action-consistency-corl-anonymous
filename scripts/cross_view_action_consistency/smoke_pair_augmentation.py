#!/usr/bin/env python3
"""Smoke test cross-view pair-aware augmentation on CPU."""
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="results/cross_view_action_consistency/pair_aug_smoke")
    ...
    after_obs = cross_view_action_consistency.preprocess_pair_observation(
        rng,
        observation,
        train=True,
    ...
    (Path("results/cross_view_action_consistency/pair_aug_smoke.md")).write_text("\n".join(lines) + "\n", encoding="utf-8")
