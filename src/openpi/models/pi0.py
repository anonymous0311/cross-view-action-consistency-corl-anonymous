...
class Pi0(_model.BaseModel):
    def __init__(self, config: pi0_config.Pi0Config, rngs: nnx.Rngs):
        ...
        llm = nnx_bridge.ToNNX(
            _gemma.Module(
                configs=[paligemma_config, action_expert_config], embed_dtype=config.dtype, adarms=config.pi05
            )
        )
    ...
    def compute_loss(
        ...
        *,
        ...
        del step
        preprocess_rng, noise_rng, time_rng, _unused_rng = jax.random.split(rng, 4)
        ...
        u_t = noise - actions
        v_t = self.predict_flow(observation, x_t, time, train=train)
    ...
    def predict_flow(
        ...
        *,
        ...
        policy's flow at a particular `(x_t, t)`, such as flow diagnostics.
