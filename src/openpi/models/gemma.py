...
class Module(nn.Module):
    ...
    def setup(self):
        ...
        block_cls = nn.remat(
            Block, prevent_cse=False, static_argnums=(5,), policy=jax.checkpoint_policies.nothing_saveable
        )
        in_axes_base = (0, nn.broadcast, nn.broadcast, nn.broadcast, nn.broadcast)
...
def _apply_rope(x, *, positions, max_wavelength=10000):
