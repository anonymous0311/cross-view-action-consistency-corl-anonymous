...
class Observation(Generic[ArrayT]):
    ...
    def from_dict(cls, data: at.PyTree[ArrayT]) -> "Observation[ArrayT]":
        ...
        return cls(
            ...
            canonical_tokens=data.get("canonical_tokens"),
            canonical_tokens_neg=data.get("canonical_tokens_neg"),
            canonical_tokens_mean=data.get("canonical_tokens_mean"),
...
def preprocess_observation(
    ...
    *,
    ...
    return Observation(
        ...
        canonical_tokens_neg=observation.canonical_tokens_neg,
        canonical_tokens_mean=observation.canonical_tokens_mean,
...
def restore_params(
    ...
    *,
    ...
    def _extract_params_item(metadata: object) -> dict[str, object]:
        ...
        # Orbax <=0.7 used a plain mapping.
        if isinstance(metadata, Mapping):
            if "params" in metadata:
                return {"params": metadata["params"]}

        # Orbax >=0.8 returns StepMetadata with item_metadata.tree.
        ...
        raise ValueError(
            "Checkpoint metadata does not contain a top-level 'params' subtree. "
            "Verify that `params_path` points to a params-only checkpoint."
        )
    ...
    with ocp.PyTreeCheckpointer() as ckptr:
        ...
        try:
            ...
            # Fallback for unexpected Orbax metadata layouts.
