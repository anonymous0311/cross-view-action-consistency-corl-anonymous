...
class Pi0V4CVConfig(pi0_config.Pi0Config):
    ...
    paired view axis is consumed only by ``compute_loss`` during Phase 0B
    training.
    """
    ...
    cv_time_distribution: Literal["legacy", "uniform", "beta_1p5_1", "beta_2p0_3p0", "beta_1p0_1p5"] = "legacy"
    ...
    def create(self, rng: at.KeyArrayLike) -> _model.BaseModel:
        from openpi.models.v4_cv import Pi0V4CV

        return Pi0V4CV(self, rngs=nnx.Rngs(rng))
